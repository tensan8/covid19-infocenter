            ...
            <nav class="navbar navbar-expand-xl yamm">
                ...
                <ul class="nav navbar-nav nav-justified w-100">
                    ...
                    <li class="nav-item" id="menu1">
                        <a class="nav-link active" href="pfizer.html">
                            Pfizer-BioNTech				</a>
                    </li>
        ...
        <main class="col-xl-9 order-xl-2">
            ...
            <div class="row">
                ...
                <div class="col content">
                    ...
                    <div class="row">
                        <br>
                        <h2 id="content" class="open d-lg-block">Pfizer-BioNTech Vaccine</h2>
                        <br>
                        <br>
                        <br>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card border-0 rounded-0 mb-3">
                                    <div class="card-body ">
										...
										<p>How given: Shot in the muscle of the upper arm</p>
                            ...
                            <div class="col-md-12">
                                <div class="card border-0 rounded-0">
                                    <div class="card-body bg-quaternary">
                                        ...
                                        <p>An <strong>allergic reaction</strong> is considered severe when a person needs to be treated with epinephrine or EpiPen© or if they must go to the hospital.</p>
                            ...
                            <div class="col-md-12">
                                <div class="card border-0 rounded-0 mb-3">
                                    <div class="card-body ">
                                        ...
                                        <br/>
                                        <p><strong>Throughout the rest of your body:</strong></p>
                                        <ul>
                                            <lI>Tiredness</lI>
                                            <li>Headache</li>
                                            <li>Muscle pain</li>
